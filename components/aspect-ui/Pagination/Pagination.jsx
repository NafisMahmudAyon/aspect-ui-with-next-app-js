...
export const Pagination = ({
	...
	return (
		<nav
			className={cn(
				"flex items-center justify-center space-x-2 flex-wrap",
				className
			)}>
			{paginationItems.map((item, index) => (
				<React.Fragment key={index}>
					{item === "start-ellipsis" || item === "end-ellipsis" ? (
						<span
							className={cn(
								"px-3 py-1 text-primary-800 dark:text-primary-100",
								ellipsisClassName
							)}>
							...
						</span>
						...
						<button
							...
							className={cn(
								"rounded-md px-3 py-1 bg-primary-100 dark:bg-primary-900 text-primary-800 dark:text-primary-200 hover:bg-primary-200 dark:hover:bg-primary-800 disabled:opacity-50 hover:text-primary-900 dark:hover:text-primary-100",
								currentPage === item &&
									"bg-primary-500 dark:bg-primary-600 dark:text-primary-50 text-primary-200",
